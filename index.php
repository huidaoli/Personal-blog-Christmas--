        ...
        <tr>
		  ...
		  <table width="262" border="0" cellspacing="0" cellpadding="0">
            <tr align="left">
              ...
              <td width="71" class="word_white"><a href="index.php"><span style="FONT-SIZE: 9pt; COLOR: #000000; TEXT-DECORATION: none">网站主页</span></a></td>
...
<?php
			...
			?>
				<font color="red"><?php echo $_SESSION[username]; ?></font>&nbsp;&nbsp;欢迎您光临我的博客网站！！！当前时间：<font color="red"><?php echo date("Y-m-d l"); ?>
</font>
			<?
				}
			?>
